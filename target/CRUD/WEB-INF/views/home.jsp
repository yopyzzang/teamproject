    ...
    <nav class="colorlib-nav" role="navigation">
        <div class="top-menu">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-2">
                        <div id="colorlib-logo"><a href="index.html">애숙</a></div>
                    </div>
                    <div class="col-xs-10 text-right menu-1">
                        <ul>
                            <li class="active"><a href="index.html">홈</a></li>
                            <li class="has-dropdown">
                                <a href="tours.html">여행</a>
                                <ul class="dropdown">
            ...
            <div class="search-wrap">
                <div class="container">
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#flight"><i class="flaticon-plane"></i> 여행</a></li>
                        <li><a data-toggle="tab" href="#hotel"><i class="flaticon-resort"></i> 호텔</a></li>
                        <li><a data-toggle="tab" href="#car"><i class="flaticon-car"></i> 렌트카</a></li>
                        <li><a data-toggle="tab" href="#cruises"><i class="flaticon-boat"></i> 크루즈</a></li>
                    </ul>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="date">지역 :</label>
                                        <div class="form-field">
                                            <input type="text" id="location" class="form-control" placeholder="지역 검색">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="form-field">
                                            ...
                                            <input type="text" id="date" class="form-control date" placeholder="체크인 날짜">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="form-field">
                                            <i class="icon icon-calendar2"></i>
                                            <input type="text" id="date" class="form-control date" placeholder="체크아웃 날짜">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
